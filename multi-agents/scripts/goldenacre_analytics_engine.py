...
# build_insight_texts() moved to goldenacre_insight_copy.py at the repo root.
# This module stays the query/compute layer; the narrative copy that both the
# Streamlit page and the pre-generated audio clips are built from lives beside
# the app instead. See that file's docstring for why.
